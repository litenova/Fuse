...
///     <list type="bullet">
///         <item>
///             <description>Directory and output path settings</description>
///         </item>
///         <item>
///             <description>File filtering options (size, binary, recursive)</description>
///         </item>
///         <item>
///             <description>Content options (metadata, gitignore, tokens)</description>
///         </item>
///         <item>
...
public abstract class CommandBase
{
    ...
    /// <summary>
    ///     Gets or sets file extensions to include in addition to template defaults.
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets file extensions to exclude from template defaults.
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets specific file names to exclude from scanning.
    /// </summary>
    [CliOption(Required = false, Description = "Exclude specific file names (e.g., appsettings.Development.json).")]
    public string[]? ExcludeFiles { get; set; }

    /// <summary>
    ///     Gets or sets user-defined glob patterns to exclude (in addition to template defaults).
    /// </summary>
    [CliOption(Required = false, Description = "Exclude files matching glob patterns (e.g., **/Migrations/**, **/*.min.js).")]
    public string[]? ExcludePatterns { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether to skip empty (zero-byte) files.
    /// </summary>
    [CliOption(Description = "Skip empty (zero-byte) files.")]
    public bool ExcludeEmptyFiles { get; set; } = true;

    /// <summary>
    ///     Gets or sets a value indicating whether to skip files that contain an auto-generated code marker.
    /// </summary>
