...
/// </para>
/// <list type="bullet">
///     <item><description>Reading file content from disk</description></item>
///     <item><description>Applying content transformations (trimming, condensing)</description></item>
///     <item><description>Applying file-type-specific minification</description></item>
/// </list>
/// <para>
...
public interface IContentProcessor
{
    ...
    /// </para>
    /// <list type="number">
    ///     <item><description>Read file content from disk</description></item>
    ///     <item><description>Trim whitespace if <see cref="FuseOptions.TrimContent"/> is enabled</description></item>
    ///     <item><description>Condense empty lines if <see cref="FuseOptions.UseCondensing"/> is enabled</description></item>
    ///     <item><description>Apply file-type-specific minification based on extension</description></item>
    /// </list>
    /// </remarks>
    /// <example>
    /// <code>
