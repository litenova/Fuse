...
///         <item>
///             <description>
///                 If <see cref="FuseOptions.OnlyExtensions" /> is set, it overrides all template/include
///                 settings
///             </description>
///         </item>
///         <item>
///             <description>If a template is specified, its defaults are used as a baseline</description>
///         </item>
///         <item>
///             <description>User-specified includes/excludes are merged with template defaults</description>
///         </item>
///         <item>
///             <description>If no template is specified, defaults to all files (*.*)</description>
///         </item>
///     </list>
/// </remarks>
