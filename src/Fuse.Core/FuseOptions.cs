...
public sealed record FuseOptions
{
    ...
    /// <summary>
    ///     Gets the specific file names to exclude from scanning.
    /// </summary>
    /// <value>An array of file names (e.g., "appsettings.Development.json"), or <c>null</c> if not specified.</value>
    public string[]? ExcludeFiles { get; init; }

    /// <summary>
    ///     Gets the user-defined glob patterns to exclude (in addition to template defaults).
    /// </summary>
    /// <value>An array of glob patterns (e.g., "**/Migrations/**", "**/*.min.js"), or <c>null</c> if not specified.</value>
    public string[]? ExcludePatterns { get; init; }

    /// <summary>
    ///     Gets a value indicating whether to skip empty (zero-byte) files.
    /// </summary>
    /// <value><c>true</c> to skip empty files; otherwise, <c>false</c>. Defaults to <c>true</c>.</value>
    public bool ExcludeEmptyFiles { get; init; } = true;

    /// <summary>
    ///     Gets a value indicating whether to skip files containing an auto-generated code marker.
    /// </summary>
    /// <value><c>true</c> to skip auto-generated files; otherwise, <c>false</c>. Defaults to <c>true</c>.</value>
    public bool ExcludeAutoGenerated { get; init; } = true;
