...
| `FUSE_BUILD_CAPTURE` | `1` | Enables build capture only for an explicit semantic request or a compiler-backed tool. The default syntax job never invokes the compiler. |
